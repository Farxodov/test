      ...
      >
        <div className="flex z-50 justify-center  gap-5 items-center max-w-[800px] m-auto px-2">
          <img
            ...
            onClick={()=>{navigate("/")}}
            className="brightness-0 invert-[1] hover:scale-[1.1] transition-all cursor-pointer"
            src={bankLogo}
            alt="bank logo"
          />
          <ul className="text-[#c4c4c4]  cursor-pointer text-[13px] font-extralight flex justify-between items-center gap-5">
            <li
              onMouseEnter={() => fHover("Pages")}
